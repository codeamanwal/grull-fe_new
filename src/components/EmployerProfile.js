        ...
        <div style={{ overflowX: 'hidden' }}>
            ...
            <div className='headerStyle' style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div className='buttonContainer'>
                    <button className='browse-freelancer-button' onClick={handleBrowseFreelancerClick}>Browse Freelancer</button>
                </div>

                <div className='buttonContainer'>
                    <button className='post-project-button' onClick={handlePostJobClick}>Post Jobs</button>
                </div>
                ...
                <div className='first-box'>
                    ...
                    {!rightBoxEditMode && (
                        <div className='inside-posted-jobs'>
                            <div style={{ marginTop: '170px', marginLeft: '480px' }}>+</div>
                            <div style={{ marginLeft: '450px' }}>Post a Job</div>
                        </div>
                    )}
                    {rightBoxEditMode && (
